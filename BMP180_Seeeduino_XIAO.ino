/*
 * BMP180 Sensor Firmware for Seeeduino XIAO
 * Reads Temperature, Pressure, and Altitude
 * * Wiring for Seeeduino XIAO:
 * BMP180 VCC  -> 3.3V
 * BMP180 GND  -> GND
 * BMP180 SDA  -> SDA (Pin 4)
 * BMP180 SCL  -> SCL (Pin 5)
...
void setup() {
  ...
  Serial.println("=================================");
  Serial.println("  BMP180 Firmware: Seeeduino XIAO  ");
  Serial.println("=================================");

  // Initialize I2C for Seeeduino XIAO
  Wire.begin();
