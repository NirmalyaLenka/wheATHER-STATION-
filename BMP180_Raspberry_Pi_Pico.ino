/*
 * BMP180 Sensor Firmware for Raspberry Pi Pico
 * Reads Temperature, Pressure, and Altitude
 * * Wiring for Raspberry Pi Pico:
 * BMP180 VCC  -> 3.3V (Pin 36)
 * BMP180 GND  -> GND (Pin 38)
 * BMP180 SDA  -> GP4 (Pin 6)
 * BMP180 SCL  -> GP5 (Pin 7)
...
void setup() {
  ...
  Serial.println("=================================");
  Serial.println("  BMP180 Firmware: Raspberry Pi Pico  ");
  Serial.println("=================================");
